...
input :: String
input = unlines [ "414 382 1515 319 83 1327 116 391 101 749 1388 1046 1427 105 1341 1590"
...
checksum = sum . map divisible

divisible :: [Int] -> Int
divisible l = case [x `div` y | x <- l, y <- l, x > y , x `mod` y == 0] of
    [res] -> res
